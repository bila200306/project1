...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $stmt = $pdo->prepare("INSERT INTO services (name, content, cta, category_id) VALUES (?, ?, ?, ?)");
        $stmt->execute([$name, $content, $cta, $category_id]);
        ...
        $_SESSION['error'] = 'Error creating service: ' . $e->getMessage();
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Create Service - Admin Panel</title>
                    ...
                    <form id="serviceForm" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="content" name="content" rows="6"
                                     class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 editor"></textarea>
